...
import com.third.service.DocumentService;
...
@RequestMapping(value = "deleteDocumentAction",method = RequestMethod.GET)
@ResponseBody
    public void deleteDocumentAction(String id)throws Exception{
